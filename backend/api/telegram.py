...
async def telegram_webhook(request: Request, background_tasks: BackgroundTasks):
    ...
    Authenticated by the secret_token registered via
    scripts/register_telegram_webhook.py: Telegram sends it back as
    X-Telegram-Bot-Api-Secret-Token. Enforced whenever
...
# Webhook registration used to be a public GET /api/telegram/register — anyone
# could trigger it. It now lives in scripts/register_telegram_webhook.py, which
# also sets the secret_token Telegram echoes back on every webhook call.
