...
Vendored from zyndai_agent.a2a.types (v0.6.0). Spec source:
  https://a2a-protocol.org/v0.3.0/specification/

Pydantic models for inbound validation; outbound construction uses
plain dicts shaped to match these models so the canonicalization
layer (canonical.py) gets a structurally-pure dict.
"""
