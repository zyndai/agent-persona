...
const CLIENTS: Client[] = [
  ...
  },
  {
    ...
    steps: [
      { title: "Configure with AI", desc: "Paste this prompt into OpenCode. The AI configures itself — no file editing needed." },
    ],
    snippet: (token, url) => `Add a new MCP server called "zynd" with transport type HTTP.\nURL: ${url}\nHeader: Authorization: Bearer ${token}`,
  },
  {
    id: "openclaw",
    name: "OpenClaw",
    ...
    snippetStep: 0, snippetLabel: "prompt",
    steps: [
      { title: "Configure with AI", desc: "Paste this prompt into OpenClaw. The AI configures itself — no file editing needed." },
    ],
    snippet: (token, url) => `Add a new MCP server called "zynd" with transport type HTTP.\nURL: ${url}\nHeader: Authorization: Bearer ${token}`,
  },
  {
